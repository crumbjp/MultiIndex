...
public class AvlTreeTest extends TestCase {
	...
	public void testEqualRange() {
		{
			Pair<AvlIterator<AvlTreeData<String>>,AvlIterator<AvlTreeData<String>>> p = tree.equalRange("B");
			assertTrue(p.first.isEnd());
			assertTrue(p.second.isEnd());
		}
		{
			Pair<AvlIterator<AvlTreeData<String>>,AvlIterator<AvlTreeData<String>>> p = tree.equalRange("A");
		...
		{
			Pair<AvlIterator<AvlTreeData<String>>,AvlIterator<AvlTreeData<String>>> p = tree.equalRange("M");
		...
		{
			Pair<AvlIterator<AvlTreeData<String>>,AvlIterator<AvlTreeData<String>>> p = tree.equalRange("K");
		...
		{
			Pair<AvlIterator<AvlTreeData<String>>,AvlIterator<AvlTreeData<String>>> p = tree.equalRange("I");
